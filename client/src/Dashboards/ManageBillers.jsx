  ...
  const handleSaveBiller = async () => {
    try {
      ...
      const updatedPayload = {
        ...
        serviceAmount: updatedData.serviceAmount || selectedBiller.serviceAmount,
      };
      ...
      // ) {
      //   toast.error("Please fill in all the editable fields.");
      //   return;
      // }
      ...
      toast.error(error.message || "An error occurred while updating the biller.");
    }
  };
                  ...
                  <div className="flex flex-col items-center ">
                    ...
                    <div className="w-full space-y-2">
                      ...
                      <div className="flex w-full items-center">
                        ...
                        <select
                          name="serviceType"
                          value={updatedData.serviceType ?? selectedBiller.serviceType}
                          onChange={(e) =>
                            setSelectedBiller({
                              ...selectedBiller,
                      ...
                      <div className="flex items-center">
                        ...
                        <Input
                          ...
                          placeholder="Amount"
                          value={ updatedData.serviceAmount ?? selectedBiller.serviceAmount}
                          onChange={(e) =>
                            setSelectedBiller({
                              ...selectedBiller,
